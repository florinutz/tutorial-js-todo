class ToDoClass {
    ...
    loadTasks() {
        document.getElementById('taskList').innerHTML = this.tasks.reduce((html, task, index) => html += ToDoClass.generateTaskHtml(task, index), '');
        localStorage.setItem('TASKS', JSON.stringify(this.tasks));
    }

    static generateTaskHtml(task, index) {
        return `
